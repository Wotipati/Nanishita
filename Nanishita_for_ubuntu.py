...
from stopwatch_ubuntu import Stopwatch
from subject_button_ubuntu import SubjectButton
...
class Timenote(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setGeometry(50, 50, 980, 360)
    ...
    def add_history(self):
        ...
        if b != 0 and self.stopwatch.is_started is False:
            ...
            font_time.setBold(False)
            button_time.setFont(font_time)
